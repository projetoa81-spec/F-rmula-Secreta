...
async function registerRoutes(app2) {
  app2.post("/api/leads", async (req, res) => {
    try {
      ...
      res.json({
        success: true,
        message: "Email capturado com sucesso! Em breve voc\xEA receber\xE1 mais informa\xE7\xF5es.",
        leadId: lead.id
      });
    } catch (error) {
      if (error instanceof z.ZodError) {
        res.status(400).json({
          success: false,
          message: "Dados inv\xE1lidos. Verifique seu email e tente novamente.",
          errors: error.errors
        });
      } else {
